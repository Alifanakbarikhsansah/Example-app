  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-lg-4">
            <label for="material"><b>Jenis Barang</b></label>
          ...
          <div class="col-lg-4">
            <label for="date_of_purchase"><b>Tanggal Pembelian</b></label>
            <input type="text" name="" class="form-control" id="date_of_purchase" placeholder="" disabled>
          </div>
          <div class="col-lg-4">
            <label for="date_of_borrow"><b>Tanggal Peminjaman</b></label>
            <input type="text" name="" class="form-control" id="date_of_borrow" placeholder="" disabled>
          </div>
        </div>
        <hr>
        <div class="row">
