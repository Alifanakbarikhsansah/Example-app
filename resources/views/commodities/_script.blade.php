        ...
        $(".show_modal").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#date_of_borrow").val(data.data.date_of_borrow)
        ...
        $("form[name='commodity_create']").submit(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    date_of_borrow: $("#date_of_borrow_create").val(),
        ...
        $(".swal-edit-button").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#date_of_borrow_edit").val(data.data.date_of_borrow)
        ...
        $("#swal-update-button").click(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    date_of_borrow: $("#date_of_borrow_edit").val(),
