      ...
      <div class="modal-body">
        <form name="commodity_create">
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label for="date_of_purchase">Tanggal Pembelian</label>
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label for="date_of_borrow">Tanggal Peminjaman</label>
                <input type="date" class="form-control" id="date_of_borrow_create">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-5">
              <div class="form-group">
                <label for="material">Jenis Barang</label>
