            ...
            <div class="modal-body">
                <form name="commodity_edit">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="acquisition">Bertanggung jawab</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="date_of_purchase_edit">Tanggal Pembelian</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="date_of_borrow_edit">Tanggal Peminjaman</label>
                                <input type="date" class="form-control" id="date_of_borrow_edit">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="form-group">
                                <label for="material_edit">Jenis Barang</label>
