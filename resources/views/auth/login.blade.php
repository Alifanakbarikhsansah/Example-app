...
<head>
    ...
    <title>Login &mdash; TIK UNILA </title>
    ...
    <link rel="shortcut icon" href="../assets/img/Logo_UnivLampung.png" type="image/x-icon">
</head>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="../assets/img/Logo_UnivLampung.png" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
                        <h5 class="text-dark font-weight-normal">Aplikasi <span class="font-weight-bold">Inventaris Barang UPT TIK</span></h5>
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                ...
                                <h5 class="font-weight-normal text-muted-transparent">Bandar Lampung, Indonesia</h5>
                            </div>
                            Check Out <a class="text-light bb" target="_blank" href="https://www.instagram.com/tikunila/?hl=id">UPT TIK UNILA</a>
                        </div>
                    </div>
                </div>
            </div>
