...
class CommodityAjaxController extends Controller
{
    public function store(Request $request)
    {
        ...
        $commodities->date_of_borrow = date_format(date_create($request->date_of_borrow),"d-m-Y");
    ...
    public function show($id)
    {
        ...
        $data = [
            ...
            'date_of_borrow' => $commodity->date_of_borrow,
    ...
    public function edit($id)
    {
        ...
        $data = [
            ...
            'date_of_borrow' => date_format(date_create($commodity->date_of_borrow),"Y-m-d"),
            'condition' => $commodity->condition,
            'quantity' => $commodity->quantity,
